...
const RemovableChannel = ({ id, name, handleChange }) => {
  ...
  return (
    <Dropdown as={ButtonGroup} className="d-flex">
      <Button className="w-100 rounded-0 text-start text-truncate" variant={getButtonVariant(id, currentChannelId)} type="button" onClick={handleChange(id)}>
        <span className="me-1"># </span>
        {name}
      </Button>
  ...
  return (
    <Col xs={4} md={2} className="border-end pt-5 px-0 bg-light">
      <div className="d-flex justify-content-between mb-2 ps-4 pe-2">
        ...
        <Button variant="outline-light" className="p-0 text-primary btn-group-vertical" onClick={handleAddChannel}>
